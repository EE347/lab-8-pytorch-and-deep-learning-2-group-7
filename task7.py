...
if __name__ == '__main__':
    ...
    for loss_type, criterion in [("CrossEntropyLoss", torch.nn.CrossEntropyLoss())]:
        ...
        cm = confusion_matrix(all_labels, all_predicted, labels=[0, 1])

        plt.figure(figsize=(6,6))
    
        import seaborn as sns
        sns.heatmap(cm, annot=True, fmt="d", cmap="Blues", xticklabels=['Jacques', 'Séamus'], yticklabels=['Jacques', 'Séamus'])
